                    ...
                    >
                        <div class="flex items-center space-x-2">
                            ...
                            <img :src="conversation.users.find(u => u.id !== this.userStore.user.id).get_avatar" class="w-[40px] rounded-full">
                                ...
                                >{{ conversation.users.find(u => u.id !== this.userStore.user.id).name }}</p>
        ...
        <div class="main-center col-span-3 space-y-4">
            <div class="bg-white border border-gray-200 rounded-lg ">
                <div class="flex flex-col flex-grow p-4"
                     v-for = "message in this.activeConversation.messages"   
                >
                    <div class="flex w-full mt-2 space-x-3 max-w-md ml-auto justify-end"
                    v-if = "message.created_by.id == this.userStore.user.id"
                    >
                        <div>
